...
app.post("/submitUser", async (req, res) => {
  ...
  if (!username && !password) {
    res.redirect("createUser?error=Enter valid user and pass");
  }

  if (!username) {
    res.redirect("createUser?error=Missing Username");
    // res.render("createUser", {error: "Missing Username"})
  }

  if (!password) {
    res.redirect("createUser?error=Missing Password");
  }
...
app.use("/member", sessionValidation);
